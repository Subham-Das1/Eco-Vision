    ...
    >
      <div className="w-full max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-6 mt-14">
          <div className="border border-[#3fa457] rounded-3xl p-8 text-center">
            <BarChart3
              size={34}
              className="mx-auto text-[#04ff00]"
            />
            ...
            <h3 className="mt-2 text-5xl font-bold text-[#e6c77a]">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mt-12">
          {/* Waste Distribution */}
          <div className="border border-[#3fa457] rounded-3xl p-8">
            <h3 className="text-2xl font-semibold text-[#e6c77a]">
              Waste Distribution
            </h3>
            ...
            <div className="mt-8">
              <div className="flex justify-between text-[#ffffff] mb-3">
            ...
            <div className="mt-8">
              ...
              <div className="w-full h-5 bg-[#1d3a21] rounded-full overflow-hidden">
                <div
                  className="h-full bg-[#e4cf9a] rounded-full"
                  style={{
            ...
            <div className="flex items-end justify-between h-72 mt-10">
              {weeklyData.map((value, index) => (
                ...
                >
                  ...
                  <span className="mt-3 text-[#ffffff] text-sm">
                    {days[index]}
                  </span>
                </div>
              ))}
        ...
        <div className="mt-12 border border-[#3fa457] rounded-3xl p-10">
          <h3 className="text-3xl font-semibold text-[#e6c77a]">
            Environmental Impact
          </h3>

          <p className="text-[#ffffff] mt-3 max-w-3xl">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            <div className="bg-[#18361f] rounded-2xl p-6">
              ...
              <h4 className="text-4xl font-bold text-[#e6c77a] mt-2">
        ...
        <div className="mt-12 border border-[#3fa457] rounded-3xl p-10">
          ...
          <div className="grid lg:grid-cols-2 gap-6 mt-8">
            <div className="bg-[#18361f] rounded-2xl p-6">
              ...
              <h4 className="mt-4 text-xl font-semibold text-[#e6c77a]">
